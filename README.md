# Brief
- This repository conatins the code I used to generate the map of goodreads, it's cuda accelerate python code I ran on an RTX 5090
- I computed the exact similarities between 1.7 million book titles and to clustered them using [240 million rows](https://cseweb.ucsd.edu/~jmcauley/datasets/goodreads.html) of user interactions
- For the UI code refer to https://github.com/narengogi/map-of-goodreads
